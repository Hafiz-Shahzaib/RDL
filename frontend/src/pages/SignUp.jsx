      ...
      <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex' onSubmit={(e)=>e.preventDefault()}>
        ...
        <div className='md:w-[50%] w-[100%] h-[100%]flex flex-col items-center justify-center gap-3'>
          ...
          <div className='flex md:w-[50%] w-[70%] items-center justify-between'>
            ...
            <span className={`px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-xl cursor-pointer hover:border-black ${role === "teacher" ? "border-black" : "border-[#646464]"}`} onClick={()=>setRole("teacher")}>Teacher</span>
        ...
        <div className='w-[50%] h-[100%] rounded-r-2xl bg-[black] md:flex items-center justify-center flex-col hidden'>
          ...
          <span className='text-2xl text-white'>REVOLUTIONIZING DIDITAL LEARNING</span>
        </div>
